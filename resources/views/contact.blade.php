...
@section('top')
    <div class="breadcum">
        <div class="container">
            <ol class="breadcrumb">
                <li>
                    <a href="{{ route('home') }}"> <i class="livicon icon3 icon4" data-name="home" data-size="18" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i>Helps
                    </a>
                </li>
                <li class="hidden-xs">
            ...
            <div class="col-md-6">
                ...
                <form class="contact" id="contact" action="#" method="POST">
                    ...
                    <div class="input-group">
                        <button class="btn btn-primary" type="submit" name="sendemail" value="sendemail" >submit</button>
            ...
            <div class="col-md-6 col-sm-6" id="address_margt">
                <div class="media media-right">
                    ...
                    <div class="media-body" style="color:#000;">
                        ...
                        <div class="danger">Main Contact Person</div>
                        <address>
                            Mr.Goutam Mondal
                            <br>127 Hazi Ismail Road
                            <br> Banorgati
                            <br> Khulna-9100
                            <br> Bangladesh
                        </address>
                    ...
                    <div class="media-body"style="color:#000;">
                        <h4 class="media-heading">Address:</h4>
                        <div class="danger">Head Office:</div>
                        <address>
                            House- 127, Hazi Ismail Road
                            <br> Banorgati
                            <br> Khulna-9100
                            <br> Bangladesh
                        </address>
                ...
                <div class="media padleft10">
                    ...
                    <div class="media-body padbtm2"style="color:#000;">
                        <h4 class="media-heading">Telephone:</h4> (+880) 41-731836
                        <br /> Mobile:(+880) 1736-425187
                        <br /> Mobile:(+880) 1752-386274
                        <br /> Mobile:(+880) 1921-109074
                ...
                <div class="media padleft10">
                    ...
                    <div class="media-body padbtm2"style="color:#000;">
                        <h4 class="media-heading">Web Address:</h4> www.heplsbd.org
                        <br /> Email:Emil-info@heplsbd.org
                        <br /> Email:Email-e.d@helpsbd.org
