...
@section('top')
        ...
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="hidden-xs">
                    ...
                    <a href="#">Climate Change & Disaster Risk Reduction</a>
                </li>

            </ol>
            <div class="pull-right">
                <i class="livicon icon3" data-name="edit" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> Climate Change & Disaster Risk Reduction
            </div>
        </div>
    </div>
    @stop
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12 wow bounceInLeft" data-wow-duration="5s"style="color:black;font-size: 15px">
