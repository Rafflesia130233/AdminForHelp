    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                <i class="livicon icon3" data-name="edit" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> Vision
            </div>
        </div>
    </div>
@stop
        ...
        <div class="row news">
            <div class="col-md-8">
                ...
                <ul style="list-style-type:circle;color: black;font-size: 30px">
                    <li>To develop a social and environmental degradation, injustice, deprivation, exclusion, hunger and poverty free Bangladesh. </li>
