        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('admin.members.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                </div>
            </div>
            <br />
                ...
                <table class="table table-bordered " id="table">
                    ...
                    @foreach ($members as $member)
                        <tr>
							...
							<td><img src="{{URL::to('uploads/crudfiles/'.$member['filePath'])}}" style="width: 30px; height: 30px;" alt="Image"></td>
                            <td>
